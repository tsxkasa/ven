...
ven::Buffer::Buffer(ven::Device& device, VkDeviceSize instanceSize,
 ...
 *
 */
void ven::Buffer::writeToBuffer(void* data, VkDeviceSize size,
                                VkDeviceSize offset) {
 ...
 *
 */
void ven::Buffer::writeToIndex(void* data, int index) {
